...
export class DashboardComponent implements OnInit 
{
  ...
  maximumClosingPrice : number = 0 ;                  //Maximum closing price   
  ...
  findMinimumVolume()
  {
    ...
    if((this.round(Math.round(minimum)) - 10000000) >= 0)
    {
      this.minimumVolume = this.round(Math.round(minimum))- 10000000 ;
    }
    else
    {
